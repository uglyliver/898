...
@Component({
  selector: 'app-team-file-disc',
  templateUrl: './team-file-disc.component.html',
  styleUrls: ['./team-file-disc.component.scss']
})
export class TeamFileDiscComponent implements OnInit {
