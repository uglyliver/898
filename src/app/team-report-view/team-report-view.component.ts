...
@Component({
  selector: 'app-team-report-view',
  templateUrl: './team-report-view.component.html',
  styleUrls: ['./team-report-view.component.scss']
})
export class TeamReportViewComponent implements OnInit {
