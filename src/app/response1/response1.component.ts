...
@Component({
  selector: 'app-response1',
  templateUrl: './response1.component.html',
  styleUrls: ['./response1.component.scss']
})
export class Response1Component implements OnInit {
startdate;enddate;
