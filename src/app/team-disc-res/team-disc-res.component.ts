...
@Component({
  selector: 'app-team-disc-res',
  templateUrl: './team-disc-res.component.html',
  styleUrls: ['./team-disc-res.component.scss']
})
export class TeamDiscResComponent implements OnInit {
