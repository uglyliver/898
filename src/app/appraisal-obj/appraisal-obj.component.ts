...
@Component({
  selector: 'app-appraisal-obj',
  templateUrl: './appraisal-obj.component.html',
  styleUrls: ['./appraisal-obj.component.scss']
})
export class AppraisalObjComponent implements OnInit {
