...
@Component({
  selector: 'app-att-reports-b',
  templateUrl: './att-reports-b.component.html',
  styleUrls: ['./att-reports-b.component.scss']
})
export class AttReportsBComponent implements OnInit {
